...
namespace eval ::optrace {
  variable script "/home/utilisateur/Bureau/projet_M2/cva6-softcore-contest/corev_apu/fpga/cva6_fpga.runs/synth_1/frontend.tcl"
...
synth_design -top frontend -part xc7z020clg400-1 -directive PerformanceOptimized -global_retiming on
...
write_checkpoint -force -noxdef frontend.dcp
OPTRACE "write_checkpoint" END { }
OPTRACE "synth reports" START { REPORT }
generate_parallel_reports -reports { "report_utilization -file frontend_utilization_synth.rpt -pb frontend_utilization_synth.pb"  } 

...
set genomeRtd $env(RT_TMP)/8056B300.rtd
set parallel_map_command "rt::do_reinfer_area_combined 1"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {cva6_hpdcache_subsystem__GB0}]"
...
set genomeName [subst -nocommands -novariables {cva6_hpdcache_subsystem__GB0}]

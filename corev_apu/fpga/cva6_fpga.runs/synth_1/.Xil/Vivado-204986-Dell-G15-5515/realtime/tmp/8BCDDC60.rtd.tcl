...
set genomeRtd $env(RT_TMP)/8BCDDC60.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {cva6_mmu_sv32}]"
...
set genomeName [subst -nocommands -novariables {cva6_mmu_sv32}]

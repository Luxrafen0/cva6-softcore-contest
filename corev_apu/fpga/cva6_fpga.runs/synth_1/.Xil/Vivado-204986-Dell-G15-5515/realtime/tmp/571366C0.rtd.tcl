...
set genomeRtd $env(RT_TMP)/571366C0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {cva6_zybo_z7_20_GT0}]"
...
set genomeName [subst -nocommands -novariables {cva6_zybo_z7_20_GT0}]

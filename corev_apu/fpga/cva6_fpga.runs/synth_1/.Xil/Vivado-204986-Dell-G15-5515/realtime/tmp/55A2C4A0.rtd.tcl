...
set genomeRtd $env(RT_TMP)/55A2C4A0.rtd
set parallel_map_command "rt::do_techmap_steps"
set rt::parallelMoreOptions "set rt::bannerSuppress true"
puts "this genome's name is [subst -nocommands -novariables {axi_xbar__GC0}]"
...
set genomeName [subst -nocommands -novariables {axi_xbar__GC0}]

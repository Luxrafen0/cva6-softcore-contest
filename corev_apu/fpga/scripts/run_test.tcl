...
# =========================================================================== #
set project cva6_fpga_test_etage
set BOARD zybo-z7-20
set XILINX_PART xc7z020clg400-1
set XILINX_BOARD digilentinc.com:zybo-z7-20:part0:1.2
set BRAM 1
set PS7_DDR 0
set TOP_ETAGE test_id
set TEST test_id.sv
create_project $project . -force -part $XILINX_PART
...
read_verilog -sv {../../../core/test_etage_time/test_id.sv}

set_property top $TOP_ETAGE [current_fileset]
...
exec mkdir -p reports_run_test_synth/
exec rm -rf reports_run_test_synth/*


check_timing -verbose                                                   -file reports_run_test_synth/$project.check_timing.rpt
report_timing -max_paths 100 -nworst 100 -delay_type max -sort_by slack -file reports_run_test_synth/$project.timing_WORST_100.rpt
report_timing -nworst 1 -delay_type max -sort_by group                  -file reports_run_test_synth/$project.timing.rpt
report_utilization -hierarchical                                        -file reports_run_test_synth/$project.utilization.rpt
report_cdc                                                              -file reports_run_test_synth/$project.cdc.rpt
report_clock_interaction                                                -file reports_run_test_synth/$project.clock_interaction.rpt
...
# reports
exec mkdir -p reports_run_test_impl/
exec rm -rf reports_run_test_impl/*
check_timing                                                              -file reports_run_test_impl/${project}.check_timing.rpt
report_timing -max_paths 100 -nworst 100 -delay_type max -sort_by slack   -file reports_run_test_impl/${project}.timing_WORST_100.rpt
report_timing -nworst 1 -delay_type max -sort_by group                    -file reports_run_test_impl/${project}.timing.rpt
report_utilization -hierarchical                                          -file reports_run_test_impl/${project}.utilization.rpt
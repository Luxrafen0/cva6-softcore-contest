...
#
# Script generated by Vivado on Tue Jan 28 11:50:11 CET 2025
# SW Build 5164865 on Thu Sep  5 14:36:28 MDT 2024
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2024 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : xlnx_clk_gen.sh
...
#
# Usage        : xlnx_clk_gen.sh
#                xlnx_clk_gen.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                xlnx_clk_gen.sh [-reset_run]
#                xlnx_clk_gen.sh [-reset_log]
#                xlnx_clk_gen.sh [-help]
#
...
#                script (type 'xlnx_clk_gen.sh -help' for more information).
#
...
# script info
echo -e "xlnx_clk_gen.sh - Script generated by export_simulation (Vivado v2024.1.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./xlnx_clk_gen.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  vlogan -work xilinx_vip $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../xilinx/xlnx_clk_gen/xlnx_clk_gen.gen/sources_1/ip/xlnx_clk_gen" +incdir+"/home/utilisateur/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"../../../ipstatic" +incdir+"../../../../xilinx/xlnx_clk_gen/xlnx_clk_gen.gen/sources_1/ip/xlnx_clk_gen" +incdir+"/home/utilisateur/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"../../../ipstatic" +incdir+"../../../../xilinx/xlnx_clk_gen/xlnx_clk_gen.gen/sources_1/ip/xlnx_clk_gen" +incdir+"/home/utilisateur/Xilinx/Vivado/2024.1/data/xilinx_vip/include" \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.xlnx_clk_gen xil_defaultlib.glbl -o xlnx_clk_gen_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./xlnx_clk_gen_simv $vcs_sim_opts -do simulate.do
}
...
create_lib_mappings()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="/home/utilisateur/Bureau/projet_M2/cva6-softcore-contest/corev_apu/fpga/cva6_fpga.cache/compile_simlib/vcs"
  fi
...
reset_run()
{
  files_to_remove=(ucli.key xlnx_clk_gen_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc xlnx_clk_gen_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./xlnx_clk_gen.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: xlnx_clk_gen.sh [-help]\n\
Usage: xlnx_clk_gen.sh [-step]\n\
Usage: xlnx_clk_gen.sh [-lib_map_path]\n\
Usage: xlnx_clk_gen.sh [-reset_run]\n\
Usage: xlnx_clk_gen.sh [-reset_log]\n\
Usage: xlnx_clk_gen.sh [-keep_index]\n\
Usage: xlnx_clk_gen.sh [-noclean_files]\n\n\
